...
const _expirationDateSchema = z.string().transform( (expiration, ctx) => {
...
const APIThesisProposalSchema = z.object({
    ...
    expiration: _expirationDateSchema
});

const APIUnarchiveThesisProposalSchema = z.object({
    expiration: _expirationDateSchema.optional()
});

module.exports = {
    APIThesisProposalSchema,
    APIUnarchiveThesisProposalSchema
};
