...
function HomeText(){
    ...
    return (
        ...
        {(isAuthenticated===true && isTeacher===true) && <Paragraph style={{ paddingLeft: "3%", textAlign: 'center' }}>Welcome professor {userData? userData.name : ""}! You can insert a new proposal or take a look for all the application requests.</Paragraph>}
        {(isAuthenticated===true && isStudent===true) && <Paragraph style={{ paddingLeft: "3%", textAlign: 'center' }}>Welcome {userData? userData.name : ""}! You can insert a new application request or take a look for all the proposals.</Paragraph>}
        {(isAuthenticated===true && isSecretaryClerk===true) && <Paragraph style={{ paddingLeft: "3%", textAlign: 'center' }}>Welcome secretary clerk {userData? userData.name : ""}! You can take a look for all thesis start requests.</Paragraph>}
